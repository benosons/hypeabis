...
header("Content-Security-Policy:default-src 'self' https: data:; img-src 'self' blob: data: https:; style-src 'self' 'unsafe-inline' https: https://fonts.gstatic.com https://fonts.googleapis.com; font-src 'self' data: https://*.gstatic.com https://*.googleapis.com;script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.google.com https://*.googlesyndication.com https://*.googletagmanager.com https://*.gstatic.com https://*.sharethis.com https://*.googleadservices.com https://*.google.co.id;");
header("Feature-Policy:sync-xhr self;sync-script self; vertical-scroll *;");
?>
...
<head>
    ...
    <script async="async" src="https://www.googletagmanager.com/gtag/js?id=G-NQ6XDKLF0C"></script>
    <script>
