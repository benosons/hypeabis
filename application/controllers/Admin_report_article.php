...
/**
 * Admin_report_article
 *
 * @property Global_lib $global_lib
 * @property CI_Input $input
 * @property Mdl_report $mdl_report
 */
class Admin_report_article extends CI_Controller {
  ...
  public function index($search_param = NULL)
  {
    ...
    $pagination_config['total_rows'] = $this->mdl_report->count_content(1, $search_param);
    ...
    $this->data['items'] = $this->mdl_report->all_content(1, $search_param, $pagination_config['per_page'], $this->data['offset']);
    ...
    $this->_render('admin/report/content');
  }
  ...
  public function export()
  {
    ...
    //get search result
    $data = $this->mdl_report->all_content(1, $search_param);
    ...
    $this->excel->streamMultipleSheet('report_artikel_' . date('YmdHis') . '.xls', $reports);
  }
