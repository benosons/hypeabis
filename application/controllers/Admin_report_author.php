 ...
 */
class Admin_report_author extends CI_Controller {
  ...
  public function index($search_param = NULL)
  {
    ...
    $pagination_config['total_rows'] = $this->mdl_report->count_author($search_param);
    ...
    $this->data['items'] = $this->mdl_report->all_author($search_param, $pagination_config['per_page'], $this->data['offset']);

    $this->_render('admin/report/author');
  }
  ...
  public function export()
  {
    ...
    //get search result
    $data = $this->mdl_report->all_author($search_param);
    $clean_data = [];
    ...
    $this->excel->streamMultipleSheet('report_author_' . date('YmdHis') . '.xls', $reports);
  }
