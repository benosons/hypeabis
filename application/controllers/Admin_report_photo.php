 ...
 */
class Admin_report_photo extends CI_Controller {
  ...
  public function index($search_param = NULL)
  {
    ...
    $pagination_config['total_rows'] = $this->mdl_report->count_content(7, $search_param);
    ...
    $this->data['items'] = $this->mdl_report->all_content(7, $search_param, $pagination_config['per_page'], $this->data['offset']);
  ...
  public function export()
  {
    ...
    //get search result
    $data = $this->mdl_report->all_content(7, $search_param);
    ...
    $this->excel->streamMultipleSheet('report_hypephoto_' . date('YmdHis') . '.xls', $reports);
  }
