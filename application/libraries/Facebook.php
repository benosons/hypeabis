...
Class Facebook
{
     ...
     * @return  string
     */
    public function login_url($alt = 0){
        $facebook_login_redirect_url = $this->config->item('facebook_login_redirect_url');
        if($alt > 0){
          $facebook_login_redirect_url = $this->config->item('facebook_login_redirect_url' . $alt);
        }
        ...
        return $this->helper->getLoginUrl(
            base_url() . $facebook_login_redirect_url,
