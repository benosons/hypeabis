<?php $search_param = $this->session->userdata('search_admin'); ?>

<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
  <?= form_open('admin_account/submitSearch', array('role' => 'form', 'class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
        ...
        <div class="row">
          ...
          <div class="col-md-10 m-b-5">
            <div class="radio radio-complete">
              <input type="radio" name="status" value="All" id="status_all" <?= ($search_param['status'] != 'active'  && $search_param['status'] != 'banned' ? 'checked' : ''); ?> />
              <label for="status_all">All</label>
              <input type="radio" name="status" value="active" id="status_active" <?= ($search_param['status'] == 'active' ? 'checked' : ''); ?> />
              <label for="status_active">Active</label>
              <input type="radio" name="status" value="banned" id="status_banned" <?= ($search_param['status'] == 'banned' ? 'checked' : ''); ?> />
      ...
      <div class="row">
        ...
        <div class="col-md-4 m-b-5">  
          <select class="full-width select_nosearch" name="search_by">
            ...
            <option value="username" <?= ($search_param['search_by'] == "username" ? "selected" : ""); ?>>username</option>
