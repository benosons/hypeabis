        ...
        <div class="card-body">
          ...
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
            <?= form_open($submit_url, ['class' => 'form-horizontal', 'role' => 'form', 'id' => 'ads_cancel_form', 'autocomplete' => 'off']); ?>
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8 col-xs-12">
                    <input type="text" class="form-control" value="<?php echo $ads->ads_name ?? '' ?>" disabled>
                  </div>
                </div>
              </div>
              ...
              <?php if (!is_null($ads->id_user)) { ?>
                <div class="form-group builtin_wrapper">
                  <div class="row">
                    <label class="col-md-3 control-label text-right sm-text-left">Pembuat</label>
                    <div class="col-md-8 col-xs-12">
                      <input class="form-control" type="text" name="name" id="name" value="<?= $ads->user_name; ?>" required <?php echo ($ads->id_user ? 'readonly' : '') ?> />
                    </div>
                  </div>
                </div>
              <?php } ?>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8 col-xs-12">
                    <input type="text" class="form-control" id="account_number" name="account_number" value="<?php echo $ads->account_number ?? '' ?>" disabled>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8 col-xs-12">
                    <input type="text" class="form-control" id="account_bank" name="account_bank" value="<?php echo $ads->account_bank ?? '' ?>" disabled>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8 col-xs-12">
                    <input type="text" class="form-control" id="account_name" name="account_name" value="<?php echo $ads->account_name ?? '' ?>" disabled>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group builtin_wrapper">
                <div class="row">
                  ...
                  <div class="col-md-8 col-xs-12">
                    <textarea class="form-control" rows="5" name="reason" disabled><?php echo $ads->reason ?? '' ?></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="radio radio-complete" style="margin-top: 0.25em;">
                      <?php if ($ads->status === '0') { ?>
                        <input type="radio" value="-1" name="status" id="status-1" <?php echo ($ads->status === '-1' ? 'checked="checked"' : ''); ?>>
                        <label for="status-1">Tolak</label>
                      <?php } ?>

                      <input type="radio" value="1" name="status" id="status1" <?php echo ($ads->status === '1' ? 'checked="checked"' : ''); ?>>
                      <label for="status1">Proses</label>

                      <input type="radio" value="2" name="status" id="status2" <?php echo ($ads->status === '2' ? 'checked="checked"' : ''); ?>>
                      <label for="status2">Selesai</label>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group collapse" id="form-group-reject-note">
                <div class="row">
                  <label class="col-md-3 control-label text-right sm-text-left">Catatan Penolakan</label>
                  <div class="col-md-8">
                    <textarea name="reject_note" class="form-control" rows="5"><?php echo $ads->reject_note ?? '' ?></textarea>
                  </div>
                </div>
              </div>

              <div class="form-group collapse" id="form-group-finish-nominal">
                <div class="row">
                  <label class="col-md-3 control-label text-right sm-text-left">Nominal</label>
                  <div class="col-md-8">
                    <div class="input-group">
                      <div class="input-group-prepend transparent">
                        <div class="input-group-text transparent">Rp. </div>
                      </div>
                      <input class="form-control text-right" type="text" name="nominal" value="<?php echo $ads->nominal ?? $ads->subtotal ?>">
                    </div>
                  </div>
                </div>
              </div>
...
function statusChanged() {
  ...
  var isRejected = value === '-1';
  var isFinished = value === '2';

  $('#form-group-reject-note').collapse(isRejected ? 'show' : 'hide');
  $('#ads_cancel_form').bootstrapValidator('enableFieldValidators', 'reject_note', isRejected);

  $('#form-group-finish-nominal').collapse(isFinished ? 'show' : 'hide');
  $('#ads_cancel_form').bootstrapValidator('enableFieldValidators', 'nominal', isFinished);
}
</script>
