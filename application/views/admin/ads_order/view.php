<?php $this->load->view('admin/ads_order/sub_header'); ?>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="form-group">
                  <div class="row">
                    <label class="col-md-3 control-label sm-text-left">Member</label>
                    <div class="col-md-9">
                      <?php echo $ads_order->user_name ?>
                    </div>
                  </div>
                    ...
                    <?php if (in_array($ads_order->payment_status, ['settlement', 'capture'])) { ?>
                      <td class="text-nowrap align-middle">
                        <?php if ($ad->id_ads && $ad->status !== '-1') { ?>
                          ...
                          <?php } else { ?>
                            <a href="<?php echo base_url() ?>admin_ads/edit/<?= $ad->id_ads; ?>" title="Edit Content" class="btn btn-xs btn-info"><span class="fa fa-pencil"></span></a>
                          <?php } ?>
                        <?php } ?>
                      </td>
                    <?php } ?>
