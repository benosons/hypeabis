        ...
        <div class="col-xl-3 col-lg-4 ">
          ...
          <div class="card card-transparent m-b-0">
            <div class="card-body p-t-0 p-b-0 text-right sm-text-center">
              <a href="<?= base_url(); ?>admin_authorcategory/add" class="btn btn-lg btn-perfect-rounded btn-complete tip m-b-5" data-placement="bottom" data-toggle="tooltip" data-original-title="Tambah penulis pilihan">
...
<div class="submenu-wrapper m-b-10" id="submenu-wrapper">
  <ul class="submenu nav binari-nav nav-tabs no-border" role="tablist">
    <li class="<?= ($function_url == '' || $function_url == 'index' ? 'active' : ''); ?>">
      <a href="<?= base_url(); ?>admin_authorcategory">
        <i class="fa fa-list"></i> Semua
      </a>
    </li>
    <li class="<?= ($function_url == 'add' ? 'active' : '') ?>">
      <a href="<?= base_url(); ?>admin_authorcategory/add">
        <i class="fa fa-plus"></i> Tambah penulis pilihan
      </a>
    </li>
  </ul>
</div>
