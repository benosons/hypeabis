...
<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
  <?= form_open('admin_content/submitSearch', array('role' => 'form', 'class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
  ...
  <div id="search_wrapper" <?= (isset($search_param['search_collapsed']) && $search_param['search_collapsed'] == '1' ? 'style="display:none"' : ''); ?>>
        ...
        <div class="col-md-3 m-b-5">
          <div class="input-group transparent">
            ...
            <select class="full-width select_nosearch" name="sort_by">
              ...
              <option value="title_asc" <?= ($search_param['sort_by'] == "title_asc" ? "selected" : ""); ?>>Alphabetical (A-Z)</option>
              <option value="title_desc" <?= ($search_param['sort_by'] == "title_desc" ? "selected" : ""); ?>>Alphabetical (Z-A)</option>
              <option value="least_liked" <?= ($search_param['sort_by'] == "least_liked" ? "selected" : ""); ?>>Like Terendah</option>
              <option value="most_liked" <?= ($search_param['sort_by'] == "most_liked" ? "selected" : ""); ?>>Like Tertinggi</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <div class="radio radio-complete">
            ...
            <label for="content_status_unpublish">Waiting approval</label>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      <div class="row">
        <label class="col-md-2 control-label text-right sm-text-left m-b-5">Like Date : </label>
        <div class="col-md-3">
          <div class="input-group tranparent">
            <div class="input-group-prepend">
              <span class="input-group-text transparent">Mulai</span>
        ...
        <div class="col-md-3">
          <div class="input-group transparent">
            ...
            <input type="text" class="form-control datepicker-component" id="datepicker-component" name="like_finish_date" value="<?= $search_param['like_finish_date']; ?>" />
          </div>
        </div>
      </div>
    </div>
