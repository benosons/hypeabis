      ...
      <div class="card card-transparent">
        <div class="card-body">
          ...
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
            ...
            <?= form_open_multipart("admin_example/saveAdd",array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'example_form', 'autocomplete' => 'off')); ?>
              
              <div class="form-group">
                <div class="row">
                  <label class="col-md-2 control-label text-right sm-text-left">Normal Text</label>
                  <div class="col-md-8 col-xs-12">
                    <input class="form-control" type="text" name="example_text"/>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8 col-xs-12">
                    <textarea class="form-control" name="example_textarea" rows="5"></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-10 col-xs-12">
                    <textarea class="ckeditor form-control" name="example_texteditor" rows="10"></textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-xs-12">
                    <select name="example_select_nosearch" class="full-width select_nosearch">
                      <option value="value1">Option example 1</option>
                      <option value="value2">Option example 2</option>
                      <option value="value3">Option example 3</option>
                      <option value="value4">Option example 4</option>
                      <option value="value5">Option example 5</option>
                    </select>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-xs-12">
                    <div class="radio radio-complete">
                      <input type="radio" value="1" name="example_radio" id="example_radio1" checked="checked">
                      <label for="example_radio1">yes</label>
                      <input type="radio" value="0" name="example_radio" id="example_radio0">
		...
		$('#example_form').bootstrapValidator({
			...
			fields: {
				example_name: {
					...
					validators: {
						notEmpty: {
							message: 'Example name is required and cannot be empty'
						}
					}
				}
			}
