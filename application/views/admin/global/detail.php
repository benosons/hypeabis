<?php $this->load->view('admin/global/sub_header'); ?>
      ...
      <div class="card card-transparent">
        <div class="card-body">
          ...
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
            ...
            <?= form_open_multipart("admin_global/updateGlobal", array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'global_setting_form', 'autocomplete' => 'off')); ?>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-5">
                  <?php if (strlen(trim($global[0]->logo)) > 0) { ?>
                ...
                <div class="col-md-5">
                  <?php if (strlen(trim($global[0]->logo_white)) > 0) { ?>
                    <div class="file-preview">
                      <div class="file-preview-thumbnails">
                        <div class="file-preview-frame">
            ...
            <div class="form-group">
              <div class="row">
                <label class="col-md-2 control-label text-right sm-text-left">Cover (admin) file:</label>
                <div class="col-md-5">
                  <?php if (strlen(trim($global[0]->cover)) > 0) { ?>
                    <div class="file-preview">
                      <div class="file-preview-thumbnails">
                        <div class="file-preview-frame">
            ...
            <div class="form-group">
              <div class="row">
                <label class="col-md-2 control-label text-right sm-text-left">Cover (kontributor) file:</label>
                <div class="col-md-5">
                  <?php if (strlen(trim($global[0]->cover_user)) > 0) { ?>
                    <div class="file-preview">
                      <div class="file-preview-thumbnails">
                        <div class="file-preview-frame">
                          <img src="<?= base_url(); ?>assets/cover/<?= $global[0]->cover_user; ?>" class="file-preview-image" title="<?= $global[0]->cover_user; ?>" width="auto" style="max-height:75px">
                        </div>
                      </div>
                      <div class="clearfix"></div>
                      <div class="file-preview-status text-center text-success"></div>
                  ...
                  <?php } ?>
                  <input type="file" class="file" name="file_cover_user" id="file_cover_user" data-show-upload="false" data-show-close="false" data-show-preview="false" data-allowed-file-extensions='["jpg", "jpeg", "png", "gif"]' />
                  <p class="hint-text"><small>*(Size Recommendation: <?= $this->cover_width; ?>px x <?= $this->cover_height; ?>px.)</small></p>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8">
                  <input class="form-control" type="text" name="meta_title" value="<?= $global[0]->meta_title; ?>" maxlength="500" />
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8">
                  <textarea class="form-control" type="text" name="meta_desc" rows="5"><?= $global[0]->meta_desc; ?></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8">
                  <textarea class="form-control" type="text" name="meta_keyword" rows="5"><?= $global[0]->meta_keyword; ?></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                <label class="col-md-2 control-label text-right sm-text-left">Admin URL:</label>
                <div class="col-md-8">
                  <input class="form-control" type="text" name="admin_token" value="<?= $global[0]->admin_token; ?>" />
                </div>
              </div>
            </div>
            ...
            <div class="form-group" style="display:none">
              <div class="row">
                <label class="col-md-2 control-label text-right sm-text-left">Privacy Policy</label>
                <div class="col-md-10">
                  <?php $content_file_path = base_url() . "assets/content/"; ?>
                  <textarea class="ckeditor form-control" name="privacy_policy" rows="10"><?= str_replace("##BASE_URL##", $content_file_path, html_entity_decode($global[0]->privacy_policy)); ?></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="form-group" style="display:none">
              <div class="row">
                <label class="col-md-2 control-label text-right sm-text-left">Terms &amp; Conditions</label>
                <div class="col-md-10">
                  <?php $content_file_path = base_url() . "assets/content/"; ?>
                  <textarea class="ckeditor form-control" name="term_condition" rows="10"><?= str_replace("##BASE_URL##", $content_file_path, html_entity_decode($global[0]->term_condition)); ?></textarea>
                </div>
              </div>
            </div>
