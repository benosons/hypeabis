<div class="table-responsive">
  <table class="table">
    ...
    <tbody>
      <?php foreach($featured_article as $item){ ?>
        <tr>
          <td class="text-nowrap">
            <a href="<?= base_url(); ?>admin_homepage/deleteFeatured/<?= $item->id_content; ?>" title="Remove from this section" class="btn btn-xs btn-info btn-need-confirmation" data-message="Anda yakin ingin menghapus konten ini dari homepage?"><span class="fa fa-times"></span></a>
          </td>
          <td>
            <b><?= $item->title; ?></b><br/>
