            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="text-nowrap"><b>Interest option</b></th>
                </tr>
              </thead>
              <tbody>
                ...
                <?php foreach($interest as $item){ ?>
                  <tr>
                    ...
                    <td class="text-nowrap align-middle">
                      <a href="<?= base_url(); ?>admin_interest/edit/<?= $item->id_interest; ?>" title="Edit Interest" class="btn btn-xs btn-info"><span class="fa fa-pencil"></span></a>
                      <a href="<?= base_url(); ?>admin_interest/delete/<?= $item->id_interest; ?>" title="Delete Interest" class="btn btn-xs btn-info btn-need-confirmation" data-message="Are you sure want to delete this data?"><span class="fa fa-times"></span></a>
                    </td>
