      ...
      <div class="card card-transparent">
        <div class="card-body">
          ...
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
            ...
            <?= form_open("admin_job/saveEdit/" . $job[0]->id_job, array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'job_form', 'autocomplete' => 'off')); ?>
            <div class="form-group">
              <div class="row">
                <label class="col-md-2 control-label text-right sm-text-left">Nama pekerjaan</label>
                <div class="col-md-8 col-xs-12">
                  <input class="form-control" type="text" name="job_name" value="<?= $job[0]->job_name; ?>" />
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-2 col-xs-12">
                  <input class="form-control" type="number" name="order" value="<?= $job[0]->order; ?>" />
                </div>
              </div>
            </div>
