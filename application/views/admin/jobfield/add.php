      ...
      <div class="card card-transparent">
        <div class="card-body">
          ...
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
            ...
            <?= form_open("admin_jobfield/saveAdd", array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'jobfield_form', 'autocomplete' => 'off')); ?>
            <div class="form-group">
              <div class="row">
                <label class="col-md-2 control-label text-right sm-text-left">Bidang pekerjaan</label>
                <div class="col-md-8 col-xs-12">
                  <input class="form-control" type="text" name="job_field" />
                </div>
              </div>
            </div>
