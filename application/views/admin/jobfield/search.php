<?php $search_param = $this->session->userdata('search_jobfield'); ?>

<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
  <?= form_open('admin_jobfield/submitSearch', array('role' => 'form', 'class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
    ...
    <div id="search_wrapper" <?= (isset($search_param['search_collapsed']) && $search_param['search_collapsed'] == '1' ? 'style="display:none"' : ''); ?>>
      ...
      <div class="form-group">
        <div class="row">
          <label class="col-md-2 control-label text-right sm-text-left m-b-5">Jobfield Radio : </label>
          <div class="col-md-10">
            <div class="radio radio-complete">
              <input type="radio" value="all" name="jobfield_radio" id="jobfield_radio_all" <?= ($search_param['jobfield_radio'] != '1'  && $search_param['jobfield_radio'] != '0' ? 'checked="checked"' : ''); ?>>
              <label for="jobfield_radio_all">All</label>
              <input type="radio" value="1" name="jobfield_radio" id="jobfield_radio_1" <?= ($search_param['jobfield_radio'] == '1' ? 'checked="checked"' : ''); ?>>
              <label for="jobfield_radio_1">Yes</label>
              <input type="radio" value="0" name="jobfield_radio" id="jobfield_radio_0" <?= ($search_param['jobfield_radio'] == '0' ? 'checked="checked"' : ''); ?>>
              <label for="jobfield_radio_0">No</label>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="row">
          <label class="col-md-2 control-label text-right sm-text-left m-b-5">Jobfield select : </label>
          <div class="col-md-6">
            <select class="full-width select_withsearch" name="jobfield_select_withsearch">
              <option value="all" <?= ($search_param['jobfield_select_withsearch'] == 'all' ? 'selected' : ''); ?>>All</option>
              <option value="0" <?= ($search_param['jobfield_select_withsearch'] == '0' ? 'selected' : ''); ?>>-</option>
              <option value="value1" <?= ($search_param['jobfield_select_withsearch'] == 'value1' ? 'selected' : ''); ?>>Option jobfield 1</option>
              <option value="value2" <?= ($search_param['jobfield_select_withsearch'] == 'value2' ? 'selected' : ''); ?>>Option jobfield 2</option>
              <option value="value3" <?= ($search_param['jobfield_select_withsearch'] == 'value3' ? 'selected' : ''); ?>>Option jobfield 3</option>
              <option value="value4" <?= ($search_param['jobfield_select_withsearch'] == 'value4' ? 'selected' : ''); ?>>Option jobfield 4</option>
              <option value="value5" <?= ($search_param['jobfield_select_withsearch'] == 'value5' ? 'selected' : ''); ?>>Option jobfield 5</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 m-b-5">  
          <select class="full-width select_nosearch" name="search_by">
            <option value="jobfield_text" <?= ($search_param['search_by'] == "jobfield_text" ? "selected" : ""); ?>>Jobfield text</option>
            <option value="jobfield_textarea" <?= ($search_param['search_by'] == "jobfield_textarea" ? "selected" : ""); ?>>Jobfield textarea</option>
          </select>
        </div>
