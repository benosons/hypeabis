      ...
      <div class="card card-transparent">
        <div class="card-body">
          ...
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
            ...
            <?= form_open("admin_level/saveEdit/" . $level[0]->id_level ,array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'level_form', 'autocomplete' => 'off')); ?>
              <div class="form-group">
                <div class="row">
                  <label class="col-md-2 control-label text-right sm-text-left">Level / Label Name</label>
                  <div class="col-md-6 col-xs-12">
                    <input class="form-control" type="text" name="level_name" value="<?= $level[0]->level_name; ?>"/>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-12">
                    <input class="form-control" type="number" name="level_point" value="<?= $level[0]->level_point; ?>"/>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-12">
                    ...
                    <input class="form-control" type="text" name="bg_color" value="<?= $level[0]->bg_color; ?>"/>
                  </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-12">
                    ...
                    <input class="form-control" type="text" name="text_color" value="<?= $level[0]->text_color; ?>"/>
                  </div>
                  </div>
                </div>
              </div>
