...
<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
  <?= form_open('admin_menu/submitSearch', array('role' => 'form', 'class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
      ...
      <div class="row">
        ...
        <div class="col-md-3 m-b-5">  
          <select class="full-width select_nosearch" name="search_by">
            <option value="menu_name" <?= ($search_param['search_by'] == "menu_name" ? "selected" : ""); ?>>Menu name</option>
          </select>
        </div>
