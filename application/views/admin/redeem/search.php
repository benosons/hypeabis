...
<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
  <?= form_open('admin_redeem/submitSearch', array('role' => 'form', 'class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
    ...
    <div id="search_wrapper" <?= (isset($search_param['search_collapsed']) && $search_param['search_collapsed'] == '1' ? 'style="display:none"' : ''); ?>>
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-md-6">
            <select class="full-width select_withsearch" name="redeem_status">
              <option value="all" <?= ($search_param['redeem_status'] == 'all' ? 'selected' : ''); ?>>Semua</option>
              <option value="0" <?= ($search_param['redeem_status'] == '0' ? 'selected' : ''); ?>>Menunggu konfirmasi</option>
              <option value="1" <?= ($search_param['redeem_status'] == '1' ? 'selected' : ''); ?>>Confirmed</option>
              <option value="2" <?= ($search_param['redeem_status'] == '2' ? 'selected' : ''); ?>>Done</option>
              <option value="3" <?= ($search_param['redeem_status'] == '3' ? 'selected' : ''); ?>>Batal</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 m-b-5">  
          <select class="full-width select_nosearch" name="search_by">
            <option value="tbl_user.name" <?= ($search_param['search_by'] == "tbl_user.name" ? "selected" : ""); ?>>User name</option>
            <option value="tbl_user.email" <?= ($search_param['search_by'] == "tbl_user.email" ? "selected" : ""); ?>>User email</option>
            <option value="tbl_merchandise.merch_name" <?= ($search_param['search_by'] == "tbl_merchandise.merch_name" ? "selected" : ""); ?>>Merch name</option>
          </select>
        </div>
