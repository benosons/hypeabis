      ...
      <div class="card card-transparent">
        <div class="card-body">
          ...
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
            ...
            <?= form_open_multipart("admin_slider/saveAdd",array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'slider_form', 'autocomplete' => 'off')); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-12">
                    <div class="input-group transparent">
                      ...
                      <input class="form-control" type="number" name="width" required="yes">
                  ...
                  <div class="col-md-4 col-xs-12">
                    <div class="input-group transparent">
                      ...
                      <input class="form-control" type="number" name="height" required="yes">
                      <div class="input-group-append">
                        <span class="input-group-text transparent">px</span>
                      </div>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-12">
                    <div class="input-group transparent">
                      ...
                      <input class="form-control" type="number" name="width_thumb" required="yes">
                      <div class="input-group-append">
                        <span class="input-group-text transparent">px</span>
                      </div>
                    </div>
                  ...
                  <div class="col-md-4 col-xs-12">
                    <div class="input-group transparent">
                      ...
                      <input class="form-control" type="number" name="height_thumb" required="yes">
                      <div class="input-group-append">
                        <span class="input-group-text transparent">px</span>
                      </div>
                    </div>
