...
<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
  <?= form_open('admin_slider/submitSearch', array('role' => 'form', 'class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
      ...
      <div class="row">
        ...
        <div class="col-md-4 m-b-5">  
          <select class="full-width select_nosearch" name="search_by">
            <option value="slider_name" <?= ($search_param['search_by'] == "slider_name" ? "selected" : ""); ?>>Slider name</option>
          </select>
        </div>
