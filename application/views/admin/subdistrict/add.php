            ...
            <div class="card card-transparent">
                <div class="card-body">
                    ...
                    <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
                        <?= form_open("admin_subdistrict/saveAdd", array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'subdistrict_form', 'autocomplete' => 'off')); ?>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-md-2 control-label text-right sm-text-left">Province</label>
                                <div class="col-md-8 col-xs-12">
                                    <select name="province" class="full-width select_withsearch province_select"
                                        id="province_select" onchange="updateCity()">
                                        <option value="">- choose province -</option>
                                        <? foreach ($province as $item): ?>
                                            <option
                                                value="<?= $item->id_province; ?>"><?= $item->province_name; ?></option>
                                        <? endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    ...
                                    <select name="city" class="full-width select_withsearch city_select"
                                        id="city_select">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <input class="form-control" type="text" name="subdistrict_name"/>
                                </div>
                            </div>
                        </div>
