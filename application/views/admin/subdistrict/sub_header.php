        ...
        <div class="col-xl-3 col-lg-4 ">
          ...
          <div class="card card-transparent m-b-0">
            <div class="card-body p-t-0 p-b-0 text-right sm-text-center">
              <a href="<?= base_url(); ?>admin_subdistrict/add" class="btn btn-lg btn-perfect-rounded btn-complete tip m-b-5" data-placement="bottom" data-toggle="tooltip" data-original-title="Add New Subdistrict">
...
<div class="submenu-wrapper m-b-10" id="submenu-wrapper">
  <ul class="submenu binari-nav nav nav-tabs no-border" role="tablist">
    <li class="<?= ($function_url == '' || $function_url == 'index' ? 'active' : ''); ?>">
      <a href="<?= base_url(); ?>admin_subdistrict">
        <i class="fa fa-list"></i> All
      </a>
    </li>
    <li class="<?= ($function_url == 'add' ? 'active' : '') ?>">
      <a href="<?= base_url(); ?>admin_subdistrict/add">
        <i class="fa fa-plus"></i> Add Subdistrict
      </a>
    </li>
    <li class="<?= ($function_url == 'syncrajaongkir' || $function_url == "startsyncrajaongkir" ? 'active' : '') ?>">
      <a href="<?= base_url(); ?>admin_subdistrict/syncRajaongkir">
        <i class="fa fa-refresh"></i> Sync with Rajaongkir API
      </a>
    </li>
  </ul>
</div>
