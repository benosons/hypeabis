          ...
          <div class="row">
            <div class="col-md-8 m-b-30">
              ...
              <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
                <?= form_open_multipart("dev_admin/updateAdmin",array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'admin_form', 'autocomplete' => 'off')); ?>
                      ...
                      <div class="col-md-9">
                        <? if(strlen(trim($admin[0]->admin_photo)) > 0){ ?>
                          <div class="file-preview">
                            <a href="<?= base_url(); ?>dev_admin/deleteAdminPic" class="close fileinput-remove text-right" title="remove / delete"><span class="fs-16 fa fa-times m-l-5 m-r-5"></span></a>
            ...
            <div class="col-md-4 m-b-30">
              ...
              <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
                <?= form_open_multipart("dev_admin/updatePassword",array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'global_setting_form', 'autocomplete' => 'off')); ?>
