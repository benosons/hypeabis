    ...
    <div class="login-wrapper ">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          <img src="<?= base_url(); ?>files/backend/img/icons/icon-alien.png" alt="logo" class="brand" data-src="<?= base_url(); ?>files/backend/img/icons/icon-alien.png" data-src-retina="<?= base_url(); ?>files/backend/img/icons/icon-alien.png">
          <p class="p-t-35">
            <h4 class="fw-700">A R E A &nbsp;&nbsp; 5 1</h4>
            Restricted area. No trespassing beyond this point.<br/>
          ...
          <!-- START Login Form -->
          <?= form_open('devarea/validateLogin', array('class' => 'p-t-15', 'id' => 'form-login')); ?>
            <!-- START Form Control-->
            <div class="form-group form-group-default">
              <label>Say the spell</label>
          ...
          <div class="pull-bottom sm-pull-bottom">
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <div class="col-sm-12 no-padding m-t-10">
                <p>
                  <small>
                    Developed by PT. Binary Cipta Solusindo.<br/>
                    Copyright &copy; 2020 BinariCMS v.7. All Rights Reserved.  <br/>
                    <a href="#"><u>Contact developer</u></a> | 
