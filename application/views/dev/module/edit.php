    ...
    <div class="col-md-12">
      ...
      <div class="card card-transparent">
        <div class="card-body">
          ...
          <h4 class="m-t-0 m-b-15 fw-600 text-heading-black">Edit Module</h4>
          
          <!-- Start Search Bar --> 
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
          
            <?= form_open_multipart("dev_module/saveEdit/" . $module[0]->id_module, array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'module_form', 'autocomplete' => 'off')); ?>
              <div class="form-group">
                <div class="row">
                  <label class="col-md-2 control-label text-right sm-text-left">Module Parent</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="module_parent_name" value="<?= ($module[0]->module_parent > 0 ? $module[0]->parent_name : '-'); ?>" readonly="yes" disabled />
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="module_name" value="<?= $module[0]->module_name; ?>" />
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control" name="module_desc" rows="5"><?= $module[0]->module_desc; ?></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <? if(strlen(trim($module[0]->module_icon_big)) > 0){ ?>
                      <div class="file-preview">
                        <div class="file-preview-thumbnails">
                          <div class="file-preview-frame">
                             <img src="<?= base_url(); ?>assets/icon/<?= $module[0]->module_icon_big; ?>" class="file-preview-image" title="<?= $module[0]->module_icon_big; ?>" width="auto" style="max-height:100px">
                          </div>
                        </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="module_icon" value="<?= $module[0]->module_icon; ?>" />
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="module_redirect" value="<?= $module[0]->module_redirect; ?>" />
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <input class="form-control" type="number" name="module_order" value="<?= $module[0]->module_order; ?>" />
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="radio radio-complete">
                      <input type="radio" value="1" name="module_status" id="module_status1" <?= ($module[0]->module_status == '1' ? 'checked="checked"' : ''); ?>>
                      <label for="module_status1">Show</label>
                      <input type="radio" value="0" name="module_status" id="module_status0" <?= ($module[0]->module_status == '0' ? 'checked="checked"' : ''); ?>>
