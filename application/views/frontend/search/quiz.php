...
$content_url = base_url("quiz/{$content->id_content}-{$author_slug}/$title_slug");
...
<div class="blog-post montana">
  <figure class="post-image">
    <a href="<?php echo $content_url ?>">
      <img data-src='<?php echo base_url("assets/quiz/thumb/{$content->content_pic_thumb}") ?>' class="lazy img-fluid" width="320" height="213" alt="<?php echo $content->title ?>">
    </a>
  </figure>
