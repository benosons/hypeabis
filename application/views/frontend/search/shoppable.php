...
$content_url = base_url("hypeshop/{$content->id_content}-{$author_slug}/$title_slug");
...
<div class="blog-post montana">
  <figure class="post-image">
    <a href="<?php echo $content_url ?>">
      <img data-src='<?php echo base_url("assets/shoppable/thumb/{$content->content_pic_thumb}") ?>' class="lazy img-fluid" width="320" height="213" alt="<?php echo $content->title ?>">
    </a>
  </figure>
  <div class="post-content">
    <ul class="post-categories">
      <li>
        <a href="<?php echo base_url('hypeshop') ?>">
          Hypeshop
        </a>
      </li>
    </ul>
