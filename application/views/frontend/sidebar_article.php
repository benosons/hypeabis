...
<div class="col-md-4">
  ...
  ?>
    <center>
      <div class="adv-home-leaderboard1 m-t-0 m-b-20">
        <? if(isset($ads['md_rec1_ar']['builtin'][0]['id_ads']) && $ads['md_rec1_ar']['builtin'][0]['id_ads'] > 0){ ?>
          <a href="<?= base_url(); ?>page/redirectAds/<?= $ads['md_rec1_ar']['builtin'][0]['id_ads']; ?>" target="_blank">
            <img src="<?= base_url(); ?>assets/adv/<?= $ads['md_rec1_ar']['builtin'][0]['ads_pic']; ?>" alt="Bisnis Muda" class="img img-fluid"/>
          </a>
        <? } else if(isset($ads['md_rec1_ar']['googleads'][0]['id_ads']) && $ads['md_rec1_ar']['googleads'][0]['id_ads'] > 0){ ?>
  ...
  <? 
    if((isset($ads['md_rec2_ar']['builtin'][0]['id_ads']) && $ads['md_rec2_ar']['builtin'][0]['id_ads'] > 0) || 
    (isset($ads['md_rec2_ar']['googleads'][0]['id_ads']) && $ads['md_rec2_ar']['googleads'][0]['id_ads'] > 0)){ 
  ?>
    <center>
      <div class="adv-home-leaderboard1 m-t-20 m-b-20">
        <? if(isset($ads['md_rec2_ar']['builtin'][0]['id_ads']) && $ads['md_rec2_ar']['builtin'][0]['id_ads'] > 0){ ?>
          <a href="<?= base_url(); ?>page/redirectAds/<?= $ads['md_rec2_ar']['builtin'][0]['id_ads']; ?>" target="_blank">
            <img src="<?= base_url(); ?>assets/adv/<?= $ads['md_rec2_ar']['builtin'][0]['ads_pic']; ?>" alt="Bisnis Muda" class="img img-fluid"/>
          </a>
        <? } else if(isset($ads['md_rec2_ar']['googleads'][0]['id_ads']) && $ads['md_rec2_ar']['googleads'][0]['id_ads'] > 0){ ?>
          <?= html_entity_decode($ads['md_rec2_ar']['googleads'][0]['googleads_code']); ?>
        <? } else {} ?>
      </div>
    </center>
  <? } ?>
