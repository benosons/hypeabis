      ...
      <div class="card card-transparent">
        <div class="card-body">
          ...
          <h4 class="m-t-0 m-b-15 fw-600 text-heading-black">
            Tambah Halaman Artikel <?php echo $content->title ?>
          </h4>
          ...
          <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
            ...
            <?php echo form_open_multipart("{$user_type}_content/saveAddNextPage/{$content->id_content}", ['class' => 'form-horizontal', 'role' => 'form', 'id' => 'content_form', 'autocomplete' => 'off']); ?>
