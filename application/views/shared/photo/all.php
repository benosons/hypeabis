                        ...
                        <table class="table">
                            ...
                            <?php foreach ($photos as $index => $item): ?>
                                <tr>
                                        ...
                                        <?php if (!is_null($item->edit_id_admin)) { ?>
                                            <?php if ($is_admin) { ?>
                                                <?php if ($item->edit_id_admin == $this->session->userdata('id_admin')) { ?>
                                                    <a href="<?php echo "{$base_url}/unlock_edit/{$item->id_content}" ?>"
                                                ...
                                                <?php } ?>
                                            <?php } else { ?>
                                                <button class="btn btn-xs btn-info" disabled title="Admin is editing">
                                    ...
                                    <td><?php echo number_format(ceil($item->comment_count), 0, ',', '.'); ?></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
