                ...
                <div class="card-body">
                    ...
                    <?php if (isset($competitions) && count($competitions) > 0) { ?>
                        <div class="d-flex">
                            ...
                            <input type="hidden" id="allow_competition_edit" value="<?= ($allow_competition_edit ? '1' : '0'); ?>">
                        </div>
                        ...
                        <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="alert alert-warning" <?= ($has_reach_submit_limit ? '' : 'style="display:none"'); ?>>
                                            Anda telah mengikutkan <?= $competitions[0]->max_content; ?> foto pada kompetisi <?php echo $competitions[0]->title; ?>.
                                            <br/>
                                            Anda hanya dapat mendaftarkan maksimal <?= $competitions[0]->max_content; ?> foto untuk kompetisi ini.
                                        </div>

                                        <?php if(isset($content->id_competition) && $content->id_competition > 0){ ?>
                                        ...
                                        <div class="radio radio-complete" <?= ($allow_competition_edit ? '' : 'style="display:none"'); ?>>
                                            <input type="radio" value="1" name="join_competition"
                                                id="join_competition1" <?= (isset($content->id_competition) && $content->id_competition > 0 ? 'checked="checked"' : ''); ?>>
                                            <label for="join_competition1" calss="text-black">Ya</label>
                                            <input type="radio" value="0" name="join_competition"
                                                id="join_competition0" <?= (!(isset($content->id_competition) && $content->id_competition > 0) ? 'checked="checked"' : ''); ?>>
                            ...
                            <div id="competition_option_wrapper" <?= (count($competitions) > 0 && isset($content->id_competition) && $content->id_competition > 0 && $allow_competition_edit ? '' : 'style="display:none"'); ?>>
                                <div class="form-group">
                                    <div class="row">
                                        <label
                    ...
                    <div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
                        ...
                        <?php if ($is_admin) { ?>
                            ...
                            <?php if ($form_value['id_competition']) { ?>
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-md-3 control-label text-right sm-text-left">Kompetisi</label>
                                        <div class="col-md-8 col-xs-12">
                                            <select name="id_competition" id="id_competition" class="full-width select_nosearch" readonly="yes">
                                                <option value="<?= $form_value['id_competition']; ?>" selected>
                                                    <?= $form_value['competition_title']; ?>
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <select name="id_competition_category" id="id_competition_category" class="full-width select_nosearch">
                                                <?php foreach ($competition_category as $cat) { ?>
                                                    <option value="<?= $cat->id_competition_category; ?>" <?= ($form_value['id_competition_category'] == $cat->id_competition_category ? 'selected' : ''); ?>>
                                                        <?= $cat->category_name; ?>
                                                    </option>
                                                <?php } ?>
                                            </select>
...
<script type="text/javascript">
    ...
    function competitionChanged() {
        let allow_competition_edit = $('#allow_competition_edit').val();
