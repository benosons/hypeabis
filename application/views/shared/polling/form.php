              ...
              <?php if (isset($content) && $is_admin) { ?>
                ...
                <?php if (!is_null($locked_content_id) && $content->id_content !== $locked_content_id) { ?>
                  <a class="btn btn-complete" href="<?php echo $base_url ?>/edit/<?php echo $locked_content_id ?>">
                    <i class="fa fa-pencil mr-1"></i> Edit Polling Terkunci
                  </a>
                <?php } ?>
              <?php } ?>
            </div>
					...
					<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
						<?php echo form_open_multipart($submit_url, ['class' => 'form-horizontal', 'role' => 'form', 'id' => 'content_form', 'autocomplete' => 'off']); ?>
							...
							<div class="form-group">
								<div class="row">
									<label class="col-md-3 control-label text-right sm-text-left">Tipe poll</label>
									<div class="col-md-8">
										<div class="radio radio-complete">
											<input type="radio" value="3" name="type" id="type3" <?php echo ($form_value['type'] == 3 ? 'checked="checked"' : ''); ?>>
											<label for="type3">Classic</label>
											<input type="radio" value="4" name="type" id="type4" <?php echo ($form_value['type'] == 4 ? 'checked="checked"' : ''); ?>>
											<label for="type4">Versus</label>
										</div>
									</div>
								</div>
							</div>
                      ...
                      <label for="content_status0"><?php echo ($is_admin ? 'Waiting approval' : 'Kirim Polling') ?></label>
