						...
						<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-10 col-xs-12">
										<input class="form-control" type="text" name="question" value="<?php echo $form_value['question'] ?>" required/>
									</div>
								</div>
							</div>
											...
											<div class="file-preview">
												...
												<div class="file-preview-thumbnails align-items-baseline">
													<div class="file-preview-frame">
														<img src="<?php echo base_url(); ?>assets/poll/questions/<?php echo $question->picture ?>" class="file-preview-image" title="<?php echo $question->picture ?>" width="auto" style="max-height:100px">
													</div>
												</div>
