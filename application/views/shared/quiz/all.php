		...
		<div class="col-md-12">
			...
			<div class="card card-transparent">
				<div class="card-body">
					...
					<!-- Start Search Bar -->
					<?php #$this->load->view('shared/quiz/search'); ?>
					<!-- End Search Bar -->
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								...
								<?php endif; ?>
								<?php foreach ($quizzes as $index => $item): ?>
									<tr>
                      ...
                      <?php } ?>
										...
										<td>
											...
											<?php echo base_url(); ?>quiz/<?php echo $item->id_content . ($item->id_user ? '-' . strtolower(url_title($item->user_name)) : ''); ?>/<?php echo strtolower(url_title($item->title)); ?>
										</td>
										...
										<td><?php echo number_format($item->like_count, 0, ',', '.'); ?></td>
