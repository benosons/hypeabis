			...
			<div class="card card-transparent">
				<div class="card-body">
					...
					<h4 class="m-t-0 m-b-15 fw-600 text-heading-black">
						<?php echo $heading_text ?> Pilihan untuk <?php echo $question->text ?>
					</h4>
					...
					<?php echo form_open_multipart($submit_url, ['class' => 'form-horizontal', 'role' => 'form', 'id' => 'content_form', 'autocomplete' => 'off']); ?>
						<div class="bg-master-lighter padding-20 m-b-20 b-rad-lg">
							...
							<div class="form-group">
								<div class="row">
									<label class="col-md-2 control-label text-right sm-text-left">Pilihan</label>
									<div class="col-md-10 col-xs-12">
							...
							<div class="form-group">
								<div class="row">
									<label class="col-md-2 control-label text-right sm-text-left">Gambar Pilihan</label>
									<div class="col-md-10 col-xs-12">
										<?php if (!empty($choice->picture)): ?>
											<div class="file-preview">
												<a href="<?php echo $base_url ?>/delete_choice_picture/<?php echo $choice->id ?>" class="close fileinput-remove text-right" title="remove / delete"><span class="fs-16 fa fa-times m-l-5 m-r-5"></span></a>
												<div class="file-preview-thumbnails align-items-baseline">
													<div class="file-preview-frame">
														<img src="<?php echo base_url(); ?>assets/quiz/choice/<?php echo $choice->picture ?>" class="file-preview-image" title="<?php echo $choice->picture ?>" width="auto" style="max-height:100px">
													</div>
												</div>
								...
								<div class="row">
									...
									<div class="col-md-10">
										<div class="radio radio-complete">
											<input type="radio" value="1" name="is_answer" id="is-answer-1" <?php echo ($form_value['is_answer'] === '1' ? 'checked="checked"' : ''); ?>>
											<label for="is-answer-1">Yes</label>
											<input type="radio" value="0" name="is_answer" id="is-answer-0" <?php echo ($form_value['is_answer'] === '0' ? 'checked="checked"' : ''); ?>>
											<label for="is-answer-0">No</label>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-8">
										...
										<a class="btn btn-default sm-m-b-10" href="<?php echo $base_url ?>/edit_question/<?php echo $question->id ?>#choices"><i class="fa fa-chevron-circle-left"></i> Back</a>
									</div>
								</div>
							</div>
						</div>
