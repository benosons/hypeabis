          ...
          <div class="full-height">
            <div class="card-body p-t-0 p-b-0 text-center">
              <?php if (count($module) > 0): ?>
                ...
                <?php endif; ?>
              <?php else: ?>
                <img class="demo-mw-600 mw-100" src="<?php echo base_url(); ?>files/backend/img/icons/icon-quiz.png"/>
              <?php endif; ?>
            </div>
          </div>
          <!-- END card -->
        ...
        <div class="col-xl-6 col-lg-6 col-md-10">
          ...
          <div class="card card-transparent m-b-0">
            <div class="card-body p-t-0 p-b-0 sm-text-center">
              <h3 class="m-t-0 fw-700 text-heading-black"><?php echo (count($module) > 0 ? $module[0]->module_name : 'Quiz') ?></h3>
              <p class="m-b-10">
                <?php if (count($module) > 0): ?>
                  <?php echo $module[0]->module_desc; ?>
                <?php else: ?>
                  Digunakan untuk mengelola konten quiz (classic &amp; paginated quiz)
                <?php endif; ?>
              </p>
            </div>
          </div>
