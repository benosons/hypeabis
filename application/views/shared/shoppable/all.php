				...
				<div class="card-body">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<?php if (count($shoppables) < 1): ?>
									<tr>
										<td class="text-center" colspan="8">Belum ada data.</td>
									</tr>
								<?php endif; ?>
								<?php foreach ($shoppables as $index => $item): ?>
									<tr>
                      ...
                      <?php } ?>
										...
										<td>
											...
											<?php echo base_url(); ?>katalogue/<?php echo $item->id_content . ($item->id_user ? '-' . strtolower(url_title($item->user_name)) : ''); ?>/<?php echo strtolower(url_title($item->title)); ?>
										</td>
