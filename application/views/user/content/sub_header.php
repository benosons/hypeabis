        ...
        <div class="col-xl-6 col-lg-6 col-md-10">
          ...
          <div class="card card-transparent">
            <div class="card-body p-t-0 p-b-0 sm-text-center">
              <h3 class="m-t-0 fw-700 text-heading-black">Artikel</h3>
              <p class="m-b-10">Halaman ini digunakan untuk mengelola konten artikel yang telah anda buat.</p>
            </div>
          </div>
          <!-- END card -->
        </div>
        ...
        <div class="col-xl-3 col-lg-4 ">
          ...
          <div class="card card-transparent m-b-0">
            <div class="card-body p-t-0 p-b-0 text-right sm-text-center">
              <a href="<?= base_url(); ?>user_content/add" class="btn btn-lg btn-perfect-rounded btn-complete tip m-b-5" data-placement="bottom" data-toggle="tooltip" data-original-title="Tambah artikel">
...
<div class="submenu-wrapper m-b-20" id="submenu-wrapper">
  <ul class="submenu nav binari-nav nav-tabs no-border" role="tablist">
    ...
    <li class="<?= ($function_url == 'add' ? 'active' : '') ?>">
      <a href="<?= base_url(); ?>user_content/add">
