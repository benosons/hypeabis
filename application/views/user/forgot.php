    ...
    <div class="register-container full-height sm-p-t-20 p-t-30">
      <div class="d-flex flex-column full-height">
        ...
        <? if(isset($global_data[0]->id_global) && (isset($global_data[0]->logo) > 0 && strlen(trim($global_data[0]->logo)) > 0)){ ?>
          ...
          <p class="p-t-40">Enter your account email address and we will send you a link to reset your password.</p>
          
          <?= $this->session->flashdata('message'); ?>
          
          <!-- START Login Form -->
          <?= form_open('user/submitForgotPassword', array('class' => 'p-t-15', 'id' => 'form-signup')); ?>
            <!-- START Form Control-->
