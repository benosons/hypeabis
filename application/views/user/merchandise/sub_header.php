        ...
        <div class="col-xl-2 col-lg-2 col-md-2 m-b-10">
          ...
          <div class="full-height">
            <div class="card-body p-t-0 p-b-0 text-center">
              <img class="demo-mw-600 mw-100" src="<?= base_url(); ?>files/backend/img/icons/icon-merchandise.png"/>
            </div>
          </div>
          <!-- END card -->
        </div>
        <div class="col-xl-8 col-lg-8 col-md-10">
          ...
          <div class="card card-transparent">
            <div class="card-body p-t-0 p-b-0 sm-text-center">
              ...
              <p class="m-b-10">Halaman ini digunakan untuk menukarkan poin yang anda kumpulkan dengan hadiah - hadiah menarik dari Bisnismuda.id</p>
            </div>
          </div>
          <!-- END card -->
        </div>
...
<div class="submenu-wrapper m-b-20" id="submenu-wrapper">
  <ul class="submenu nav binari-nav nav-tabs no-border" role="tablist">
    ...
    <li class="<?= ($function_url == 'redeem' || $function_url == 'request' ? 'active' : '') ?>">
      <a href="<?= base_url(); ?>user_merch/redeem">
        <i class="fa fa-refresh"></i> Penukaran Poin
      </a>
    </li>
  </ul>
</div>
